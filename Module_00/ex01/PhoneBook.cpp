...
/*   Updated: 2022/09/09 02:07:02 by smodesto         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	PhoneBook::Add(void)
{
	...
	NewContact.SetFirstName(buffer[0]);
	NewContact.SetLastName(buffer[1]);
	NewContact.SetNickName(buffer[2]);
	NewContact.SetDarkestSecret(buffer[3]);
	NewContact.SetPhoneNumber(buffer[4]);
